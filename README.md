...
<p align="center">
  <img src="https://t4.ftcdn.net/jpg/00/75/17/15/360_F_75171518_FPVzsehsk5OiUZs4YekTXtMje3ktFZBL.jpg" alt="Faixa do Zoológico" width="50%">
</p>

## Descrição

O projeto **RecintosZoo** é uma aplicação que gerencia os recintos de um zoológico e aloca animais de acordo com suas necessidades e características. A classe principal, _RecintosZoo_, permite verificar quais recintos são adequados para um determinado animal com base em fatores como bioma, tamanho e compatibilidade com outros animais presentes no recinto.

## Funcionalidades

- **Gerenciamento de Recintos:**

     + Inicializa e armazena dados sobre os recintos do zoológico, incluindo número, bioma, tamanho e animais já alocados.

- **Características dos Animais:**

     + Define as características de vários animais, como tamanho, biomas adequados e se são carnívoros ou herbívoros.

- **Análise de Recintos:**

     + O método analisaRecintos determina quais recintos são viáveis para alocar um determinado animal com base nas suas características e quantidade solicitada.

> Abaixo informações do desafio e como realizá-lo:
